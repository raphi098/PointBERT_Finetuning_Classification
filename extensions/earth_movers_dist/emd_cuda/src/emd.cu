...
#ifndef EMD_KERNEL_CU_
#define EMD_KERNEL_CU_
...
// Make it a real equality check, not a macro alias to CHECK_EQ (which may not exist)
...
Output:
  match: (B, N2, N1)
*/
at::Tensor approxmatch_forward_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES(xyz1.scalar_type(), "approxmatch_forward", ([&] {
...
at::Tensor matchcost_forward_cuda(const at::Tensor xyz1,
  ...
  AT_DISPATCH_FLOATING_TYPES(xyz1.scalar_type(), "matchcost_forward_cuda", ([&] {
...
Output:
  ...
  grad2: (B, N2, 3)
*/
std::vector<at::Tensor> matchcost_backward_cuda(
  ...
  AT_DISPATCH_FLOATING_TYPES(xyz1.scalar_type(), "matchcost_backward", ([&] {
